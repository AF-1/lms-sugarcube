...
sub handler {
	...
	if ($params->{'saveSettings'}) {
		...
		my $sugarcube_restrict_genre = $params->{'sugarcube_restrict_genre'} ? 1 : 0;
		...
		my $sugarcube_clear = $params->{'sugarcube_clear'} ? 1 : 0;
		$prefs->client($client)->set('sugarcube_clear', "$sugarcube_clear");

		my $sugarcube_volume_flag = $params->{'sugarcube_volume_flag'} ? 1 : 0;
		...
		my $sugarcube_vartist = $params->{'sugarcube_vartist'} ? 1 : 0;
		...
		my $sugarcube_dynamicq = $params->{'sugarcube_dynamicq'} ? 1 : 0;
		...
		my $sugarcube_clearstats = $params->{'sugarcube_clearstats'} ? 1 : 0;
		...
		my $sugarcube_albumoveride = $params->{'sugarcube_albumoveride'} ? 1 : 0;
